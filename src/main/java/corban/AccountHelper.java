...
{
  private static String  _id = "IDL:corban/Account:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[5] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (corban.AccountHelper.id (), "Account", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    corban.Account value = new corban.Account ();
