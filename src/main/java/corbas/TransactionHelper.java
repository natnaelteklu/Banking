...
{
  private static String  _id = "IDL:corba/Transaction:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[4] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (corbas.TransactionHelper.id (), "Transaction", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    corbas.Transaction value = new corbas.Transaction ();
